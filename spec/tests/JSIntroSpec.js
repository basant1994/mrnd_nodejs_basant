...
describe("JSIntro Test Suite", function(){
	...
	describe("JSIntro-SumOfUniqueNumbers", function(){
		...
		it("sum of 2,3,3,2 is 5", function(){
			...
			console.log("Type of sumof uinque numbers "+ typeof(JSIntro.SumOfUniqueNumbers));
	...
	describe("JSIntro-ReverseArrayOfStrings",function(){
		...
		it("basant kumar reversed is kumar basant",function(){
			var str = ["basant","kumar"];
			str=JSIntro.ReverseArrayOfStrings(str);
			expect(str).toEqual(["kumar","basant"]);
		});
		
		it("basant reversed is basant",function(){
			var str = ["basant"];
			str=JSIntro.ReverseArrayOfStrings(str);
			expect(str).toEqual(["basant"]);
		});
	});
});